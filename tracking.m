function [ newX,newalpha,likelihood ] = tracking( dataset,sigma,lambda )
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
T=size(dataset,1);
%initialize
newlambda=sigma^2/lambda^2;
...
%M step
    ...
    A(1,1,1)=newalpha(1,1)+newlambda;
    A(1,2,1)=-newlambda;
    
    A(T,T,1)=newalpha(T,1)+newlambda;
    A(T,T-1,1)=-newlambda;
    
    A(1,1,2)=newalpha(1,2)+newlambda;
    A(1,2,2)=-newlambda;
    
    A(T,T,2)=newalpha(T,2)+newlambda;
    A(T,T-1,2)=-newlambda;
    ...
    for i=2:T-1
        newalpha(i,:)=sum(P{i});
        A(i,i,1)=newalpha(i,1)+2*newlambda;
        A(i,i+1,1)=-newlambda;
        A(i,i-1,1)=-newlambda;
        A(i,i,2)=newalpha(i,2)+2*newlambda;
        A(i,i+1,2)=-newlambda;
        A(i,i-1,2)=-newlambda;
